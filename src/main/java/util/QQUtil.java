...
public class QQUtil {
     ...
     * @return 返回解析后的字符串数组
     */
    public static String[] analyticalQqReturn(String headStr, String str) {
     ...
     * @throws Exception 异常
     */
    public static Object exeJavascript(File file, String functionName, Object... params) throws Exception {
     ...
     */
    public static String hexchar2bin(String hexStr) throws UnsupportedEncodingException {
